...
//		new Game();
	...
	Game() {
		...
		shapes = new Shape[5];
		shapes[0] = new Shape(50, 10, 20, 20, 1, 1, ShapeType.Rectangle);
		shapes[1] = new Shape(200, 10, 50, 50, 3, 3, ShapeType.ThreeDRectangle);
		shapes[2] = new Shape(20, 250, 30, 30, 2, 2, ShapeType.RoundRectangle);
		shapes[3] = new Shape(120, 20, 30, 30, 2, 2, ShapeType.Oval);
		shapes[4] = new Shape(200, 50, 30, 30, 2, 2, ShapeType.Arc);
